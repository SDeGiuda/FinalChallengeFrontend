import { type ComponentProps, type ComponentType, type InputHTMLAttributes, useState } from "react";
...
export const FormSection = ({ Icon, error, title, type, value, ...rest }: FormSectionProps) => {
  ...
  return (
    <div className="flex flex-col gap-1 font-manrope text-project-gray">
      ...
      <div
        className={twMerge(
          "flex gap-2 rounded-md bg-white px-3 py-3 align-middle transition-all duration-200 ease-out",
          isFocus && "shadow-lg",
