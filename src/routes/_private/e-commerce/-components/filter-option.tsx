...
export const FilterOption = ({ option }: { option: Option }) => {
  ...
  return (
    <div className="w-full px-5">
      ...
      <ul
        className={twMerge(
          "flex origin-top flex-col items-start gap-8 pt-3 transition-all duration-500 ease-out lg:absolute",
          "lg:-top-0 lg:left-80 lg:z-10 lg:h-full lg:w-60 lg:origin-left lg:bg-white lg:px-5 lg:pt-40 lg:text-orange-500 lg:shadow-md",
          open
            ? "scale-y-100 opacity-100 lg:translate-x-0"
            : "scale-y-0 opacity-0 lg:-translate-x-80 lg:scale-y-100",
        )}
      >
        {open
